...
public class Main {
    public static void main(String[] args) {
        ...
        User user = new User();
        user.setEmal("nurkamil@gmail.com");
        user.setPassword("nurkamil21");
        users[0] = user;
        Admin ad = new Admin();
        ...
        while (true) {
            ...
            switch (actionmain) {
                ...
                case "2" -> {
                    if (users.length >= 1) {
                        User user2 = User.checLogin(users);
                        if (user2.getEmal().equalsIgnoreCase("nurkamil@gmail.com")){
                            LOOP2:
                            while (true) {
